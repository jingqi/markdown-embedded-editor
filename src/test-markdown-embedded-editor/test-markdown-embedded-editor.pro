...
mac {
    ...
    libs.files = \
        ...
        $$OUT_PWD/../../3rdparty/markdown-view.git/src/discount/libdiscount.1.dylib \
        $$OUT_PWD/../../3rdparty/markdown-view.git/src/hoedown/libhoedown.1.dylib \
    ...
    SRC = $$OUT_PWD/../../3rdparty/markdown-view.git/src/discount/$${DEBUG_MODE}/discount.dll
    POST_TARGETDEPS += $${SRC}
    SRC ~= s,/,\\,
    QMAKE_POST_LINK += $$quote(cmd /c xcopy /y /i $${SRC} $${DST}$$escape_expand(\n\t))

    SRC = $$OUT_PWD/../../3rdparty/markdown-view.git/src/hoedown/$${DEBUG_MODE}/hoedown.dll
    POST_TARGETDEPS += $${SRC}
    SRC ~= s,/,\\,
    QMAKE_POST_LINK += $$quote(cmd /c xcopy /y /i $${SRC} $${DST}$$escape_expand(\n\t))

    SRC = $$OUT_PWD/../../3rdparty/markdown-view.git/src/markdown-view/$${DEBUG_MODE}/markdown-view1.dll
    POST_TARGETDEPS += $${SRC}
    SRC ~= s,/,\\,
    QMAKE_POST_LINK += $$quote(cmd /c xcopy /y /i $${SRC} $${DST}$$escape_expand(\n\t))
    ...
    SRC = $$OUT_PWD/../../3rdparty/markdown-view.git/src/discount/libdiscount.1.so
    POST_TARGETDEPS += $${SRC}
    QMAKE_POST_LINK += cp -Lf $${SRC} $$OUT_PWD/ ;

    SRC = $$OUT_PWD/../../3rdparty/markdown-view.git/src/hoedown/libhoedown.1.so
    POST_TARGETDEPS += $${SRC}
    QMAKE_POST_LINK += cp -Lf $${SRC} $$OUT_PWD/ ;

    SRC = $$OUT_PWD/../../3rdparty/markdown-view.git/src/markdown-view/libmarkdown-view.1.so
    POST_TARGETDEPS += $${SRC}
    QMAKE_POST_LINK += cp -Lf $${SRC} $$OUT_PWD/ ;
